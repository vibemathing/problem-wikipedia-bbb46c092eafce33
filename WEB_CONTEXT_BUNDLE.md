...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-bbb46c092eafce33"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-bbb46c092eafce33",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-bbb46c092eafce33",
        "url": "https://en.wikipedia.org/wiki/Van_der_Corput%27s_method#Exponent_pairs"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Exponent pair conjecture : for all $\\varepsilon >0$ , is the pair $(\\varepsilon ,1/2+\\varepsilon )$ an exponent pair ?",
      "version": 1
    },
    "title": "Exponent pair conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "ef760e1886f024ef184d88d5c546e1a23dd59d2ac970c053baaf904757618a72"
}
```
